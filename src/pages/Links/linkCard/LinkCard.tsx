...
function LinkCard({ Logo, HoverLogo, title, handle, url }: LinkCardProps) {
  return (
    ...
    >
      ...
      <span className="mt-6 hidden font-ubuntu text-gray-700 dark:text-gray-300 xl:inline">{title}</span>
      <div className="h-full w-0 border-r-2 border-gray-500 transition-colors duration-300 xl:mt-10 xl:h-0 xl:w-full xl:border-t-2 xl:group-hover:border-amber-900 xl:group-hover:bg-white/20 xl:dark:group-hover:border-purple-400"></div>
