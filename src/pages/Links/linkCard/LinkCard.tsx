...
function LinkCard({ Logo, HoverLogo, title, handle, url }: LinkCardProps) {
  return (
    ...
    >
      ...
      <HoverLogo className="animate-lower-bounce h-0 w-0 fill-amber-900 opacity-0 transition-opacity duration-700 group-hover:top-0 group-hover:mt-4 group-hover:h-24 group-hover:w-2/5 group-hover:opacity-100 dark:fill-purple-400" />
