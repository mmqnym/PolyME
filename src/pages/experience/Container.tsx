...
function Container({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <Helmet>
        <title>{t("navigator.Experience")} - PolyME</title>
        <meta name="description" content="This page shows 0xmmq's development experience." />
        ...
        <meta property="og:description" content="This page shows 0xmmq's development experience." />
      </Helmet>
      {children}
    </div>
  );
