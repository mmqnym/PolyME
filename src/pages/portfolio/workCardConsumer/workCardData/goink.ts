...
const goinkData: WorkCardProps = {
  ...
  links: [
    ...
    { icon: githubLinkIcon, alt: "goink-github-link", url: "https://github.com/mmqnym/GoInk" },
  ],
  description: "GoInk is a project template that helps developers quickly build a server. Use the gin framework.",
  stack: {
    languages: [
      {
        name: "Go",
