...
function Detail() {
  ...
  return (
    <div className="col-span-3 col-start-4 row-span-4 row-start-7 h-full w-full rounded-2xl border border-gray-700 bg-gray-700/30">
      ...
      <p
        className={`mt-2 h-4/5 w-full overflow-y-auto whitespace-pre-line px-6 pb-5 font-ubuntu text-lg ${workCardContext.isSwitchingCard ? "animate-pulse text-gray-200/30" : "text-gray-200"} transition-all duration-300 scrollbar-thin scrollbar-track-transparent scrollbar-track-rounded-full scrollbar-thumb-rounded-full`}
      >
