...
function SkillList({ category, child }: Props) {
  return (
    <div className="group mt-12 cursor-default select-none pb-6 sm:pb-12">
      <h2 className="text-2xl tracking-wide text-gray-700 transition-colors duration-500 group-hover:text-amber-900 dark:text-gray-300 dark:group-hover:text-purple-400 sm:text-4xl">
        {category}
      </h2>
