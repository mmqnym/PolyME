...
function MobileLanguageSwitchPage({ showLanguageMenu, setShowLanguageMenu }: Props) {
  ...
  return (
    <div
      className={`${
        !showLanguageMenu ? "hidden" : ""
      } w-full h-full text-xl -top-44 left-0 absolute z-[2000] bg-gradient-to-tl from-orange-100 via-orange-100 to-orange-200 transition-transform duration-300 dark:border-gray-500/70 dark:from-stone-950/90 dark:to-stone-950 pt-16`}
    >
